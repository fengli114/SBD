...
public class StatusBarUtils {
     ...
     * @param toolbar
     */
    public static void fixToolbar1(Toolbar toolbar, Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
    ...
    public static void fixToolbar(Context activity,LinearLayout toolbar) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            int statusHeight = getStatusBarHeight(activity);
            LinearLayout.MarginLayoutParams layoutParams = (LinearLayout.MarginLayoutParams) toolbar.getLayoutParams();
            layoutParams.setMargins(0, statusHeight, 0, 0);
        }
    }
    /**

...
public interface ParterLoginContract {

        abstract class LoginPresenter extends BasePresenter<ParterLoginContract.ILoginModel, ParterLoginContract.ILoginView> {

...
public class ShopDtailesActivity extends BaseMVPCompatActivity<GoodsDtailContract
    ...
    private GoodesAdapter sAdapter;
    private List<GoodsBean.JsonBean.HotsBean> lists;
    private GoodsBean.JsonBean.HotsBean infoBean;
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        sAdapter = new GoodesAdapter(R.layout.item_shop);
        rv_shop.setAdapter(sAdapter);
        rv_shop.setLayoutManager(new LinearLayoutManager(mContext));
        lists = (List<GoodsBean.JsonBean.HotsBean>) getIntent().getSerializableExtra("remen");
    }
     ...
     */
    public static void start(Activity context, GoodsBean.JsonBean.HotsBean infoBean, ImageView imageView) {
        Intent intent = new Intent(context, ShopDtailesActivity.class);
                ...
                // 设置取消按钮,null是什么都不做，并关闭对话框
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (AppUtils.isInstallApp("com.taobao.taobao")) {
                            ...
                            WebViewActivity.skip(ShopDtailesActivity.this, shopDetailBean.getJson().getTbkInfo().getTbkurl(), "粉丝福利购");
                        }
                    }
                });
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        sAdapter = new GoodesAdapter(R.layout.item_shop, lists);
                        sAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                            ...
                            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                                ...
                                index = position;
                                infoBean = (GoodsBean.JsonBean.HotsBean) adapter.getItem(position);
                        ...
                        initHeadView();
                        sAdapter.addHeaderView(headView);
                        rv_shop.setAdapter(sAdapter);
        ...
        headView.findViewById(R.id.rl_gd_detail).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (AppUtils.isInstallApp("com.taobao.taobao")) {
                    ...
                    WebViewActivity.skip(ShopDtailesActivity.this, shopDetailBean.getJson().getCommodities().getDetailurl(), "商品详情");
                }
            }
        });

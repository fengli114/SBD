...
import com.mhy.shopingphone.contract.phone.tabs.DialContract;
...
public class DialFragment extends BaseRecycleFragment<DialContract.DialPresenter,
        DialContract.IDialModel> implements DialContract.IDialView {
    ...
    @Override
    public void updateContentList(List<PhoneItemBean> list) {

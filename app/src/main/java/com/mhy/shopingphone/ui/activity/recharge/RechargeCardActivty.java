...
public class RechargeCardActivty extends BaseMVPCompatActivity<RechargeContract.RechargePresenter
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        LogUtils.e("wowo" + (String) SharedPreferencesHelper.getInstance().getData("Recharge2", ""));
        Glide.with(getBaseContext()).load((String) SharedPreferencesHelper.getInstance().getData("Recharge2", "")).into(imgPicture);

    }

    @Override
    protected boolean hiddenKeyboard() {
        return super.hiddenKeyboard();
    }

    //请求
    private void goRecharge(final String substr) {
        showWaitDialog("请稍等...");
...
//                            SharedPreferencesHelper.getInstance().saveData("UserId", ceshi.getID());//代理Id
                            Contant.gwjMoney = ceshi.getMoney();
                            finish();
    ...
    protected int getLayoutId() {
        return R.layout.activity_recharge_card_activty;
    }

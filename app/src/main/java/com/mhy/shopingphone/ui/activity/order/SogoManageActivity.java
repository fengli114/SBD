...
import com.mhy.shopingphone.ui.activity.SogoAmendActivity;
 ...
 * 商户管理
 */
public class SogoManageActivity extends BaseMVPCompatActivity<MyOrderContract.MyOrderPresenter,
    ...
    private void initRecycleView(final List<UserInfoers.JsonBean.UsersBean> list) {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(SogoManageActivity.this, SogoAmenddeletiActivity.class);

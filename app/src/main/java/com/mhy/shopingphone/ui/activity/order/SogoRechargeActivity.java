...
import com.mhy.shopingphone.ui.activity.RechargeZhanghuActivity;
 ...
 * 商户充值
 */
public class SogoRechargeActivity extends BaseMVPCompatActivity<MyOrderContract.MyOrderPresenter,
...
//                mPresenter.loadOrderList(paramsstring);
    ...
    protected void onResume() {
        super.onResume();
        mAdapter = new SogoManageAdapter(R.layout.item_sogo_manage);
    ...
    private void loadMyOrderList(int page, SogoManageAdapter adapyer) {
...
/*
    ...
    private void initRecycleView(final List<UserInfoers.JsonBean.UsersBean> list) {
        mAdapter = new SogoManageAdapter(R.layout.item_sogo_manage, list);
        mAdapter.setOnLoadMoreListener(this, rvMyOrder);
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(SogoRechargeActivity.this, RechargeZhanghuActivity.class);

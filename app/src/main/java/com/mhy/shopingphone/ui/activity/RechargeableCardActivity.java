 ...
 * 充值卡管理
 */
public class RechargeableCardActivity extends BaseMVPCompatActivity<MyOrderContract.MyOrderPresenter,
...
//                mPresenter.loadOrderList(paramsstring);
    ...
    protected void onResume() {
        super.onResume();
        mAdapter = new RechargeableCardAdapter(R.layout.item_user_icards);
    ...
    private void loadMyOrderList(int page, RechargeableCardAdapter adapyer) {
...
//                .addHeader("SDB-Authorization", String.valueOf(SharedPreferencesHelper.getInstance().getData("Tokens", "")))
    ...
    public void onViewClicked(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_shuaxin:
                mAdapter = new RechargeableCardAdapter(R.layout.item_user_infoes);
                rvMyOrder.setLayoutManager(new LinearLayoutManager(this));
                rvMyOrder.setAdapter(mAdapter);
                loadMyOrderList(1, null);
                break;
    ...
    private void initRecycleView(final List<UserInfoers.JsonBean.UsersBean> list) {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(RechargeableCardActivity.this, SogoAmenddeletiActivity.class);
    ...
    private void initHeadView() {
        if (headView == null) {
            headView = ResourcesUtils.inflate(R.layout.rechargeable_trans_layout);
        }
    }
}

...
public class CardidTransferAdapter extends BaseCompatAdapter<UserInfoers.JsonBean.UsersBean, BaseViewHolder> {
    private CharSequence textctr;
    private EditText et_tbnumber;

    public CardidTransferAdapter(@LayoutRes int layoutResId, @Nullable List<UserInfoers.JsonBean.UsersBean> data) {
        super(layoutResId, data);
        init();
    }

    public CardidTransferAdapter(@Nullable List<UserInfoers.JsonBean.UsersBean> data) {
        super(data);
        init();
    }

    public CardidTransferAdapter(@LayoutRes int layoutResId) {
        super(layoutResId);
        init();
    }

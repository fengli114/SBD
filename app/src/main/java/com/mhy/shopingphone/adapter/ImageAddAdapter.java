...
import com.mhy.shopingphone.ui.activity.ModelXiuGaiActivity;
...
public class ImageAddAdapter extends BaseCompatAdapter<Modelers.JsonBean, BaseViewHolder> {
    private CharSequence textctr;
    private EditText et_tbnumber;

    public ImageAddAdapter(@LayoutRes int layoutResId, @Nullable List<Modelers.JsonBean> data) {
        super(layoutResId, data);
        init();
    }

    public ImageAddAdapter(@Nullable List<Modelers.JsonBean> data) {
        super(data);
        init();
    }

    public ImageAddAdapter(@LayoutRes int layoutResId) {
        super(layoutResId);
        init();
    }
    ...
    protected void convert(BaseViewHolder helper, final Modelers.JsonBean item) {
        helper.setText(R.id.tv_urles, item.getUrl())
        ...
        helper.getView(R.id.tv_xiugai).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent2 = new Intent(mContext, ModelXiuGaiActivity.class);

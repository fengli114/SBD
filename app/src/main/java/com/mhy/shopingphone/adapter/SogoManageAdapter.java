...
public class SogoManageAdapter extends BaseCompatAdapter<UserInfoers.JsonBean.UsersBean, BaseViewHolder> {
    private CharSequence textctr;
    private EditText et_tbnumber;

    public SogoManageAdapter(@LayoutRes int layoutResId, @Nullable List<UserInfoers.JsonBean.UsersBean> data) {
        super(layoutResId, data);
        init();
    }

    public SogoManageAdapter(@Nullable List<UserInfoers.JsonBean.UsersBean> data) {
        super(data);
        init();
    }

    public SogoManageAdapter(@LayoutRes int layoutResId) {
        super(layoutResId);
        init();
    }

...
public class TipDialog extends Dialog {
    ...
    public TipDialog(Context context, int themeResId, String content, View.OnClickListener onClickListener) {
        super(context, themeResId);
        this.context = context;
        this.content = content;
        this.onClickListener = onClickListener;
        view = LinearLayout.inflate(context, R.layout.dialog_tip, null);
    }
    ...
    private void initView() {
        tvSettingContent.setText("您确认用"+content+"元话费抵扣此商品？");

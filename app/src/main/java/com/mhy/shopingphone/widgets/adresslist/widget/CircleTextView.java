package com.mhy.shopingphone.widgets.adresslist.widget;
...
public class CircleTextView extends View {
    ...
    private void initView(){
        ...
        circlePaint.setColor(getResources().getColor(R.color.txtGray));
        circleTextPaint.setColor(getResources().getColor(R.color.white));

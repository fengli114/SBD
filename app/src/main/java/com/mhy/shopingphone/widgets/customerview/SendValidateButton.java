...
import com.mhy.shopingphone.widgets.SDTimer;
...
//        gradientDrawable.setStroke(ViewUtils.dp2px(1), mTextColorEnable);
        //   gradientDrawable.setCornerRadius(ViewUtils.dp2px(5));
    ...
    public void updateViewState(boolean enable) {
        if (enable) {
            ...
            if (mBackgroundEnableResId != 0) {
                ViewUtils.setBackgroundResource(this, mBackgroundEnableResId);
            }
        } else {
//            this.setText(mDisableTimeTemp + mTextDisable);
            this.setText(mDisableTimeTemp + "秒");
            if (mTextColorDisable != 0) {
                this.setTextColor(mTextColorDisable);
            }
            if (mBackgroundDisableResId != 0) {
                ViewUtils.setBackgroundResource(this, mBackgroundDisableResId);
            }
        }
    }
